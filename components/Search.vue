<template>
  <section
    class="scroll-con-sec hero-section"
  ...
  >
      ...
      <div class="container">
        ...
        <div class="main-search-input-wrap">
          <div class="main-search-input fl-wrap">
            ...
            <div
              class="main-search-input-item location"
    ...
    <div class="header-sec-link">
      <div class="container">
        <a href="#sec2" class="custom-scroll-link">Let's Start</a>
      </div>
    </div>
  </section>
</template>
...
#sec1 {
  background-image: url('~assets/images/bg/32.jpg')
}
</style>
